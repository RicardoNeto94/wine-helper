(function(){
  ...
  async function loadData() {
    try {
      const res = await fetch(`./assets/wines.json?v=${VERSION}`, { cache: 'reload' });
      ...
      if (cached) {
        ...
        showNotice("Could not load wines.json. If opened as a local file, host it (GitHub Pages/Vercel) or run a local server.");
      }
