const CACHE_NAME='foh-wine-burgundy-20250908180836';
const ASSETS=["./", "./index.html", "./styles.css?v=20250908180836", "./app.js?v=20250908180836", "./manifest.json", "./wines.json", "./menu.json", "./images-map.json", "./placeholder-bottle.png"];
